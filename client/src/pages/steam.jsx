...
const Steam = () => {
    ...
    <div className='container'>
        ...
        <section className={styles.hero} id="hero">
            <img src={require('../assets/images/steam-icon.svg').default} alt="steam logo" className="cards" />
        ...
        <div className='form' id="login">
            <form>
                ...
                <input type="text" placeholder="Steam User" name="username" id="Username" className="login-input"/>
                    <p id="error"></p>
